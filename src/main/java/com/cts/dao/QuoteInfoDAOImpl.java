...
public class QuoteInfoDAOImpl implements QuoteInfoDAO {
	...
	public void create(QuoteInfo quoteInfo) {
		jdbcTemplate.update(SQL_CREATE,
				quoteInfo.getMemberCounty(),
				quoteInfo.getEntityType(),
				quoteInfo.getFirstName(),
				quoteInfo.getLastName(),
				quoteInfo.getDob(),
				quoteInfo.getSsn(),
				quoteInfo.getAddress1(),
				quoteInfo.getAddress2(),
				quoteInfo.getCounty(),
				quoteInfo.getPrimaryPhone(),
				quoteInfo.getSecondaryPhone(),
				quoteInfo.getEmailAddress(),
				quoteInfo.getQuoteStatus(),
				quoteInfo.getLobInterested(),
				quoteInfo.getPremiumRange());
	}
...
//						rs.getString("county"),
//						rs.getInt("primary_phone"),
//						rs.getInt("secondary_phone"),
//						rs.getString("email_address"),
						rs.getString("quote_status"),
						rs.getString("lob_interested"),
